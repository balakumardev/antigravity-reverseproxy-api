...
// Server configuration (defaults match src/constants/shared.js)
const DEFAULT_BASE_URL = 'http://localhost:48123';
const baseUrl = normalizeBaseUrl(process.env.ANTHROPIC_BASE_URL || process.env.PROXY_BASE_URL) || DEFAULT_BASE_URL;
const url = new URL(baseUrl);
const BASE_URL = url.hostname;
