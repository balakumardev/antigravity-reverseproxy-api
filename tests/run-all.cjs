...
async function main() {
    ...
    console.log('╚══════════════════════════════════════════════════════════════╝');
    console.log('');
    console.log('Make sure the server is running (default: http://localhost:48123) before running tests.');
    console.log('You can override with ANTHROPIC_BASE_URL (e.g. http://localhost:48123).');
    console.log('');
